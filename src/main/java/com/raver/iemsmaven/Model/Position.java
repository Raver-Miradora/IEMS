...
public class Position {
    ...
    public static int getPositionIdByName(String posName, int deptId) {
        // Note: We filter by department_id to ensure the position matches the department in the CSV
        String query = "SELECT position_id FROM position WHERE position_name = ? AND department_id = ?";
