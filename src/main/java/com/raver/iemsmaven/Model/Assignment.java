...
public class Assignment {
    ...
    public static void addAssignment(Connection conn, int userId, int positionId, int shiftId, String startTime, String endTime, String dateAssigned) throws SQLException {
